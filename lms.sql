-- ============================================================
-- LMS FRESH INSTALL — Run this to reset the database completely
-- ============================================================
...
-- Classes (one row per class, admin creates these)
CREATE TABLE CLASSES (
    class_id      INT AUTO_INCREMENT PRIMARY KEY,
    teacher_id    INT NOT NULL,
    class_name    VARCHAR(255) NOT NULL,
    student_limit INT DEFAULT 30,
    created_at    TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (teacher_id) REFERENCES TEACHER_INFO(teacher_id) ON DELETE CASCADE
);

-- Class enrollments (students self-register)
