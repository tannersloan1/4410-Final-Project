...
<head>
    ...
    <style>
        ...
        .stat-box span{display:block;font-size:0.75rem;color:#475569;text-transform:uppercase;letter-spacing:.04em;margin-bottom:4px;}
        .stat-box strong{font-size:1.8rem;color:#fff;font-weight:800;}
        .action-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:28px;}
        .action-card{background:#1e293b;border:1px solid #334155;border-radius:14px;padding:24px;text-decoration:none;color:inherit;display:flex;flex-direction:column;gap:10px;transition:transform .2s,border-color .2s;}
        .action-card:hover{transform:translateY(-3px);border-color:#475569;}
        .action-card .icon{font-size:2rem;}.action-card h2{font-size:1rem;font-weight:800;}.action-card p{color:#64748b;font-size:0.87rem;line-height:1.55;}
        .card-btn{display:inline-block;padding:9px 16px;border-radius:8px;font-weight:700;font-size:0.87rem;text-decoration:none;color:#fff;margin-top:auto;font-family:inherit;}
        .panel{background:#1e293b;border:1px solid #334155;border-radius:14px;padding:24px;}
        .panel h2{font-size:1rem;font-weight:800;color:#f8fafc;margin-bottom:16px;}
        .log-table{width:100%;border-collapse:collapse;}
        .log-table th,.log-table td{padding:10px 12px;text-align:left;border-bottom:1px solid #1e293b;font-size:0.85rem;color:#e2e8f0;}
        .log-table th{color:#64748b;font-size:0.75rem;text-transform:uppercase;}
        .log-table tr:last-child td{border-bottom:none;}
        @media(max-width:800px){.stats-grid,.action-grid{grid-template-columns:1fr 1fr;}}
    </style>
</head>
<body>
...
<main class="page">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-box"><div class="icon">📋</div><span>Quizzes</span><strong><?= $total_quizzes ?></strong></div>
    ...
    <div class="action-grid">
        <a href="teacher.php" class="action-card">
            <div class="icon">✏️</div><h2 style="color:#3b82f6">Teachers</h2>
        ...
        <a href="student.php" class="action-card">
            <div class="icon">🎓</div><h2 style="color:#22c55e">Students</h2>
        ...
        <a href="analytics.php" class="action-card">
            <div class="icon">📊</div><h2 style="color:#a855f7">Analytics & Logs</h2>
    ...
    <div class="panel">
        ...
        <table class="log-table">
            <thead><tr><th>Role</th><th>Action</th><th>Description</th><th>Time</th></tr></thead>
            <tbody>
        ...
        <?php else: ?><p style="color:#475569">No activity logged yet.</p><?php endif; ?>
    </div>
</main>
