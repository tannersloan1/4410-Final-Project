    ...
    if ($class_name === "") {
        ...
        if ($sql->execute()) {
            logActivity(
                ...
                $_SESSION["role"],
                "CREATE",
                "Admin created class: $class_name (teacher: $teacher_id, limit: $limit)",
                "CLASSES"
            );
...
<main class="page">
    <div class="breadcrumb">
        <a href="admin-dash.php">Dashboard</a> › Classes
    </div>

    <div class="hero">
        <h1>🏫 Manage Classes</h1>
        <p>Create classes and assign teachers. Students can self-enroll from their dashboard.</p>
    </div>
    ...
    <div class="two-col">
        ...
        <div class="card">
                    ...
                    <tbody>
                        <?php while ($c = $classes_r->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td style="color:#475569; font-size:.8rem">
            ...
            <?php else: ?>
                <p style="color:#475569">No classes yet.</p>
            <?php endif; ?>
        </div>
