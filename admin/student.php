...
$quizzes_result = $conn->query(
    "SELECT q.quiz_id, q.title, q.description, q.time_limit, q.created_at,
            ...
            ss.submitted_at
     FROM QUIZZES q
     JOIN CLASSES qc         ON q.class_id    = qc.class_id
     JOIN CLASSES c          ON c.class_name  = qc.class_name AND c.student_id = $student_id
...
// Student's personal average across all completed quizzes
$avg_r = $conn->query(
    ...
    <div class="progress-wrap">
        ...
        <div class="progress-bar">
            <div class="progress-fill"
                 style="width:<?= $total_count > 0 ? round($done_count / $total_count * 100) : 0 ?>%"></div>
        </div>
    </div>
    <?php endif; ?>
